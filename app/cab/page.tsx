...
export default function CABPage() {
  ...
  const handleApprovalDecision = (decision: "approved" | "rejected" | "on-hold", comments: string) => {
            ...
            <TabsContent value="meetings" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Schedule and manage Change Advisory Board meetings</CardDescription>
                </CardHeader>
                <CardContent>
